...
create_ctx(void)
{
  ...
  ctx.psi_eval = 0.001514; //psi_RZ(ctx.RatZeq0, 0.0, &ctx)* 1. / 2.;
...
int main(int argc, char **argv)
{
  ...
  struct gkyl_gyrokinetic_species ion = {
    ...
    .init_from_file = {
      ...
      .file_name = "initial-condition/gk_lorentzian_mirror-ion_5.gkyl",
    ...
    .time_rate_multiplier = {
      ...
      .multiplier[0] = {
        ...
        .cfl_factor_times_omega_max = 1/10.,
        .cellwise_const = true,
        .write_diagnostics = true,
      },
    },
