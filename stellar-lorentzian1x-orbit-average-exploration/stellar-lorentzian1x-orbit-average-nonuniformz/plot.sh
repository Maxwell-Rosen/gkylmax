...
# pgkyl gk_lorentzian_mirror-ion_BiMaxwellianMoments_55.gkyl ../stellar-lorentzian1x-orbit-average/gk_lorentzian_mirror-ion_BiMaxwellianMoments_55.gkyl interp ev 'f 2,3 1.67e-27 2.014 * 1.6e-19 / scale_comp' pl -f0 --legend "skip_cell,regular" --logy --title 'Bi-Maxwellian Moments — comparison (frame 55)' --xlabel 'Axial Position z (m)' --subplot-ylabels 'Density $m^{-3}$, $U_\parallel$ (m/s), $T_\parallel$ (eV), $T_\perp$ (eV)' --saveas python-plots/ion_BiMaxwellianMoments_compare_55.pdf &
