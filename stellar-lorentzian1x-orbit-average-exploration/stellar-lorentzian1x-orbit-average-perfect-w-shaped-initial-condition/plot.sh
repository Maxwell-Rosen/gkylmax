...
pgkyl  --c2p gk_lorentzian_mirror-mc2nu_pos_deflated.gkyl gk_lorentzian_mirror-ion_BiMaxwellianMoments_10.gkyl ../stellar-lorentzian1x-orbit-average-unif-ic-with-skipcell-1e-16/gk_lorentzian_mirror-ion_BiMaxwellianMoments_10.gkyl interp ev 'f 2,3 1.67e-27 2.014 * 1.6e-19 / scale_comp' pl --title 'Bi-Maxwellian Moments Comparison at Frame 10' --saveas python-plots/ion_BiMaxwellianMoments_comparison_frame10.png --no-show --subplot-ylabels 'Density $m^3$, $U_\parallel m/s$, $T_\parallel$ eV, $T_\perp$ eV' --legend "Shaped IC, Uniform IC" -f0&