...
pgkyl $name-cmag.gkyl interp -b ms -p1 pl --title 'cmag' --saveas "python-plots/$name-cmag.png" --no-show &
pgkyl $name-bmag.gkyl interp -b ms -p1 pl --title 'bmag' --saveas "python-plots/$name-bmag.png" --no-show &
pgkyl $name-jacobgeo.gkyl interp -b ms -p1 pl --title 'jacobgeo' --saveas "python-plots/$name-jacobgeo.png" --no-show &
pgkyl $name-jacobtot.gkyl interp -b ms -p1 pl --title 'jacobtot' --saveas "python-plots/$name-jacobtot.png" --no-show &
pgkyl $name-jacobtot_inv.gkyl interp -b ms -p1 pl --title 'jacobtot_inv' --saveas "python-plots/$name-jacobtot_inv.png" --no-show &
pgkyl $name-jacobgeo_inv.gkyl interp -b ms -p1 pl --title 'jacobgeo_inv' --saveas "python-plots/$name-jacobgeo_inv.png" --no-show &
pgkyl $name-mapc2p.gkyl interp -b ms -p1 pl --title 'mapc2p' --saveas "python-plots/$name-mapc2p.png" --no-show &
