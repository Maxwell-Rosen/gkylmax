...
dataDir = '/home/mr1884/scratch/Link to scratch_traverse/gkylmax/traverse-wham1x-compare_unif_vs_nonunif_fraction/outputs/'
unifFile = 'gk_wham_unif'
nonunifFile = 'gk_wham_nonunif'
reducedFile = 'gk_wham_reduced'
frame_arr = np.arange(20,21)
...
def process_frame(frameNum):
  ...
  if plot_moments:
    ...
    ax[0,0].plot(dataOut_reduced_mapc2p[:,0], dataOut_reduced[:,0],'g:', label='Nonuniformity 0.3')
    ...
    ax[0,1].plot(dataOut_unif_mapc2p[:,0], dataOut_unif[:,0],'r', label='Nonuniformity 0.0')
    ax[0,1].plot(dataOut_nonunif_mapc2p[:,0], dataOut_nonunif[:,0],'b--', label='Nonuniformity 0.7')
    ax[0,1].plot(dataOut_reduced_mapc2p[:,0], dataOut_reduced[:,0],'g:', label='Nonuniformity 0.3')
    ...
    ax[1,0].plot(M0_map[:,0], upar_unif / c_s,'r', label='Nonuniformity 0.0')
    ax[1,0].plot(M0_nonunif_map[:,0], upar_nonunif / c_s,'b--', label='Nonuniformity 0.7')
    ax[1,0].plot(M0_reduced_map[:,0], upar_reduced / c_s,'g:', label='Nonuniformity 0.3')
    ...
    ax[1,1].plot(M0_map[:,0], tPerp_unif,'r', label='Nonuniformity 0.0')
    ax[1,1].plot(M0_nonunif_map[:,0], tPerp_nonunif,'b--', label='Nonuniformity 0.7')
    ax[1,1].plot(M0_reduced_map[:,0], tPerp_reduced,'g:', label='Nonuniformity 0.3')
    ...
    ax[1,2].plot(M0_map[:,0], tPar_unif,'r', label='Nonuniformity 0.0')
    ax[1,2].plot(M0_nonunif_map[:,0], tPar_nonunif,'b--', label='Nonuniformity 0.7')
    ax[1,2].plot(M0_reduced_map[:,0], tPar_reduced,'g:', label='Nonuniformity 0.3')
