...
struct gk_mirror_ctx
{
  ...
  struct gkyl_basis posit_basis;
  
  struct gkyl_range posit_local;
...
int main(int argc, char **argv)
{
  ...
  struct gkyl_mirror_geo_grid_inp grid_inp = {
    .filename_psi = "../../gkylzero/data/unit/wham_hires.geqdsk_psi.gkyl", // psi file to use
