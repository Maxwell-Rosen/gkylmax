...
struct gk_mirror_ctx
{
  ...
  double time_dilation_f_threshold; // Threshold for time dilation factor in loss cone multiplier.
};
...
create_ctx(void)
{
  ...
  int num_frames_fdp_extra = 200;  // Frames for the extra FDP phase
  ...
  double time_dilation_f_threshold = 1e-4; // Threshold for time dilation factor in loss cone multiplier.
  ...
  struct gk_mirror_ctx ctx = {
    ...
    .Z_min = Z_min,
    .Z_max = Z_max,
    .time_dilation_f_threshold = time_dilation_f_threshold,
  };
  ...
  struct gk_poa_phase_params *pparams, int phase_idx)
{
  ...
  struct gkyl_gyrokinetic_fdot_multiplier fdot_mult_inp = {
    ...
    .f_threshold = ctx->time_dilation_f_threshold,
    .cellwise_const = true,
...
int main(int argc, char **argv)
{
  ...
  struct gkyl_gyrokinetic_species ion = {
    ...
    .init_from_file = {
      ...
      .file_name = "initial-condition/gk_lorentzian_mirror-ion_200.gkyl",
    },
    // .projection = {
