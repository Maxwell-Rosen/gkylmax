...
int main(int argc, char **argv)
{
  ...
  struct gkyl_gyrokinetic_species ion = {
    ...
    .init_from_file = {
      ...
      .file_name = "/global/homes/m/mhrosen/scratch/gkylmax/a-thesis-simulations/1x-beams/zzim-ion_70.gkyl",
    },
  ...
  struct gkyl_gyrokinetic_species elc = {
    ...
    // .init_from_file = {
    //   .type = GKYL_IC_IMPORT_F,
    //   .file_name = "/global/homes/m/mhrosen/scratch/gkylmax/a-thesis-simulations/1x-beams/zzim-elc_70.gkyl",
    // },
    .projection = {
  ...
  struct gkyl_gyrokinetic_field field = {
    ...
    .polarization_potential_import = {
      .type = GKYL_IC_IMPORT_F,
      .file_name = "/global/homes/m/mhrosen/scratch/gkylmax/a-thesis-simulations/1x-beams/zzim-field_75.gkyl",
    }
  };
