...
pgkyl --c2p gk_lorentzian_mirror-mc2nu_pos_deflated.gkyl "gk_lorentzian_mirror-ion_BiMaxwellianMoments_[0-9]*.gkyl" interp ev 'f 2,3 1.67e-27 2.014 * 1.6e-19 / scale_comp' anim  --float --saveas "python-plots/bimaxwellian_moments.mp4" &
