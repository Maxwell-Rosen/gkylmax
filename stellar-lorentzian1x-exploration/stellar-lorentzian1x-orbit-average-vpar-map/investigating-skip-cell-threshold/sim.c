...
struct gk_mirror_ctx
{
  ...
  double int_diag_calc_num; // Frequency of calculating integrated diagnostics (as a factor of num_frames).
...
create_ctx(void)
{
  ...
  int num_frames_fdp = 100;        // Frames per FDP phase
  ...
  double int_diag_calc_num = 100; // Frequency of calculating integrated diagnostics (as a factor of num_frames).
...
int main(int argc, char **argv)
{
  ...
  struct gkyl_gyrokinetic_species ion = {
    ...
    .init_from_file = {
      ...
      .file_name = "../gk_lorentzian_mirror-ion_5-copy",
    },
