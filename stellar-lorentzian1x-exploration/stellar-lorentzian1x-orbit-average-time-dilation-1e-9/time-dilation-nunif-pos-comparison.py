...
directory_POA_simulation = '/home/mr1884/scratch/gkylmax/stellar-lorentzian1x-orbit-average-exploration/stellar-lorentzian1x-orbit-average-time-dilation-1e-9'
directory_hires_simulation = '/home/mr1884/scratch/gkylmax/stellar-lorentzian1x-orbit-average-exploration/stellar-lorentzian1x-orbit-average-time-dilation-compare-without'
...
ax[0, 2].set_ylim(-7, 7)
ax[0, 2].legend([r'$\Delta t_{\rm min} = 10^{-8}$ s', r'$\Delta t_{\rm min} = 0.0$ s'])
...
# plt.tight_layout()
plt.savefig('time-dilation-nunif-pos-comparison.pdf')
plt.show()
