...
directory_hires_simulation = '/home/mr1884/scratch/gkylmax/stellar-lorentzian1x-orbit-average-exploration/stellar-lorentzian1x-orbit-average-positivity-new-version'
...
ax[0, 2].set_ylim(-7, 7)
ax[0, 2].legend([r'Old positivity', r'New positivity'])
...
# plt.tight_layout()
plt.savefig('new-vs-old-pos-updater-comparison.pdf')
plt.show()
