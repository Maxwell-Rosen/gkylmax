...
# pgkyl "BiMaxwellianMoments/gk_wham_32-ion_BiMaxwellianMoments_[0-9]*.gkyl" interp anim --float
# pgkyl "gk_wham_32-elc_BiMaxwellianMoments_[0-9]*.gkyl" interp anim --float &
# pgkyl "gk_wham_32-ion_BiMaxwellianMoments_[0-9]*.gkyl" interp anim --float &
# pgkyl "gk_wham_32-field_[0-9]*.gkyl" interp anim --float &

# pgkyl "BiMaxwellianMoments/gk_wham_32-"$species"_BiMaxwellianMoments_[0-9]*.gkyl" interp sel --z0 0.0 -c0 collect pl --logy --xlabel "Time, s" --ylabel "Ion density, m^{-3}" --title "Midplane Ion density 32 cells" &
...
# pgkyl "Field/gk_wham_32-field_[0-9]*.gkyl" interp sel --z0 0.0 -c0 collect pl --xlabel "Time, s" --ylabel "Potential, V" --title "Midplane potential 32 cells" &
...
# pgkyl --c2p-vel gk_wham_32-ion_mapc2p_vel.gkyl Distributions/gk_wham_32-ion_62.gkyl interp sel --z0 2 pl --title "Initial" &
# pgkyl --c2p-vel gk_wham_32-ion_mapc2p_vel.gkyl Distributions/gk_wham_32-ion_63.gkyl interp sel --z0 2 pl --title "63" &
# pgkyl --c2p-vel gk_wham_32-ion_mapc2p_vel.gkyl Distributions/gk_wham_32-ion_64.gkyl interp sel --z0 2 pl --title "64" &
# pgkyl --c2p-vel gk_wham_32-ion_mapc2p_vel.gkyl Distributions/gk_wham_32-ion_68.gkyl interp sel --z0 2 pl --title "68" --logz --zmin 1e-20 &

pgkyl --c2p-vel gk_wham_32-"$species"_mapc2p_vel.gkyl Distributions/gk_wham_32-"$species"_150.gkyl interp sel --z0 0.0 pl --title "150 microseconds 32 cells" --logz --zmin 1e-20 &
...
# pgkyl --c2p-vel gk_wham_32-ion_mapc2p_vel.gkyl "Distributions/gk_wham_32-ion_[0-9]*.gkyl" interp sel --z0 2 anim --logz --zmin 1e-20 &
# pgkyl --c2p-vel gk_wham_32-ion_mapc2p_vel.gkyl "Distributions/gk_wham_32-ion_[0-9]*.gkyl" interp sel --z0 2 anim --float &

# pgkyl --c2p-vel gk_wham_32-elc_mapc2p_vel.gkyl "Distributions/gk_wham_32-elc_[0-9]*.gkyl" interp sel --z0 2 anim --logz --zmin 1e-20 &
# pgkyl --c2p-vel gk_wham_32-elc_mapc2p_vel.gkyl "Distributions/gk_wham_32-elc_[0-9]*.gkyl" interp sel --z0 2 anim --float &

# pgkyl BiMaxwellianMoments/gk_wham_32-ion_BiMaxwellianMoments_62.gkyl interp pl --title "Initial" &
# pgkyl gk_wham_32-ion_BiMaxwellianMoments_62.gkyl interp pl --title "Restart" &
# pgkyl gk_wham_32-ion_BiMaxwellianMoments_63.gkyl interp pl --title "63" &
# pgkyl gk_wham_32-ion_BiMaxwellianMoments_64.gkyl interp pl --title "64" &



# pgkyl Distributions/gk_wham_32-ion_62.gkyl interp sel --z0 0.0 pl --title "Initial" &
# pgkyl gk_wham_32-ion_62.gkyl interp sel --z0 0.0 pl --title "Restart" &
