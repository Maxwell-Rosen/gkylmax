...
pgkyl --c2p gk_lorentzian_mirror-mc2nu_pos_deflated.gkyl gk_lorentzian_mirror-ion_BiMaxwellianMoments_100.gkyl ../stellar-lorentzian1x-orbit-average/gk_lorentzian_mirror-ion_BiMaxwellianMoments_100.gkyl interp ev 'f 2,3 1.67e-27 2.014 * 1.6e-19 / scale_comp' pl --xlabel 'Axial Position z (m)' -f0 --legend "time dilation, without" --subplot-ylabels "Density, U_||, T_||, T_|" &


pgkyl --c2p gk_lorentzian_mirror-mc2nu_pos_deflated.gkyl gk_lorentzian_mirror-ion_BiMaxwellianMoments_100.gkyl ../stellar-lorentzian1x-orbit-average/gk_lorentzian_mirror-ion_BiMaxwellianMoments_100.gkyl interp ev 'f 2,3 1.67e-27 2.014 * 1.6e-19 / scale_comp' ev 'f[1] f[0] - f[1] /' pl --xlabel 'Axial Position z (m)' -f0 --legend "time dilation, without" --subplot-ylabels "Density, U_||, T_||, T_|" &
