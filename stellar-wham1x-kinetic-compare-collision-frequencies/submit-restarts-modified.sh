...
first_job_id=$(sbatch jobscript-gkyl-stellar-modified | awk '{print $4}')
...
do
  ...
  next_job_id=$(sbatch --dependency=afterany:$previous_job_id jobscript-gkyl-stellar-modified | awk '{print $4}')
  job_ids+=($next_job_id)
done
