...
# pgkyl --c2p-vel gk_lorentzian_mirror-ion_mapc2p_vel.gkyl gk_lorentzian_mirror-ion_${frame}.gkyl interp sel --z0 0.0 ev 'f abs' pl --xlabel 'Parallel Velocity $v_\parallel$ (m/s)' --ylabel 'Magnetic Moment $\mu$ (J/T)' --logz --zmin 1e-20 --title "Ion Distribution Function at z=0.0 (Frame ${frame})" --saveas python-plots/ion_distf_z0.0_frame${frame}.png --no-show &
# pgkyl --c2p-vel gk_lorentzian_mirror-ion_mapc2p_vel.gkyl gk_lorentzian_mirror-ion_${frame}.gkyl interp sel --z0 0.5 ev 'f abs' pl --xlabel 'Parallel Velocity $v_\parallel$ (m/s)' --ylabel 'Magnetic Moment $\mu$ (J/T)' --logz --zmin 1e-20 --title "Ion Distribution Function at z=0.5 (Frame ${frame})" --saveas python-plots/ion_distf_z0.5_frame${frame}.png --no-show &
# pgkyl --c2p-vel gk_lorentzian_mirror-ion_mapc2p_vel.gkyl gk_lorentzian_mirror-ion_${frame}.gkyl interp sel --z0 0.98 ev 'f abs' pl --xlabel 'Parallel Velocity $v_\parallel$ (m/s)' --ylabel 'Magnetic Moment $\mu$ (J/T)' --logz --zmin 1e-20 --title "Ion Distribution Function at z=0.98 (Frame ${frame})" --saveas python-plots/ion_distf_z0.98_frame${frame}.png --no-show &
# pgkyl --c2p-vel gk_lorentzian_mirror-ion_mapc2p_vel.gkyl gk_lorentzian_mirror-ion_${frame}.gkyl interp sel --z0 1.5 ev 'f abs' pl --xlabel 'Parallel Velocity $v_\parallel$ (m/s)' --ylabel 'Magnetic Moment $\mu$ (J/T)' --logz --zmin 1e-20 --title "Ion Distribution Function at z=1.5 (Frame ${frame})" --saveas python-plots/ion_distf_z1.5_frame${frame}.png --no-show &
# pgkyl --c2p-vel gk_lorentzian_mirror-ion_mapc2p_vel.gkyl gk_lorentzian_mirror-ion_${frame}.gkyl interp sel --z0 1.9 ev 'f abs' pl --xlabel 'Parallel Velocity $v_\parallel$ (m/s)' --ylabel 'Magnetic Moment $\mu$ (J/T)' --logz --zmin 1e-20 --title "Ion Distribution Function at z=1.9 (Frame ${frame})" --saveas python-plots/ion_distf_z1.9_frame${frame}.png --no-show &
...
# pgkyl ../stellar-lorentzian1x-orbit-average-no-positivity/gk_lorentzian_mirror-ion_BiMaxwellianMoments_100.gkyl gk_lorentzian_mirror-ion_BiMaxwellianMoments_100.gkyl interp ev 'f 2,3 1.67e-27 2.014 * 1.6e-19 / scale_comp' pl -f0 --legend "1e-16,1e-20" --title 'Bi-Maxwellian Moments — comparison (frame 100)' --xlabel 'Axial Position z (m)' --subplot-ylabels 'Density $m^{-3}$, $U_\parallel$ (m/s), $T_\parallel$ (eV), $T_\perp$ (eV)' --saveas "python-plots/ion_BiMaxwellianMoments_compare_100.png" --no-show &

pgkyl gk_lorentzian_mirror-ion_100.gkyl interp sel --z0 0.95 pl --title 'Distribution Function at z=0.95' --xlabel '$v_\parallel$' --ylabel '$\mu$'&
pgkyl gk_lorentzian_mirror-ion_100.gkyl interp sel --z0 0.98 pl --title 'Distribution Function at z=0.98' --xlabel '$v_\parallel$' --ylabel '$\mu$'&
pgkyl gk_lorentzian_mirror-ion_100.gkyl interp sel --z0 1.0 pl --title 'Distribution Function at z=1.0' --xlabel '$v_\parallel$' --ylabel '$\mu$'&
pgkylgk_lorentzian_mirror-ion_100.gkyl interp sel --z0 1.02 pl --title 'Distribution Function at z=1.02' --xlabel '$v_\parallel$' --ylabel '$\mu$'&
pgkyl gk_lorentzian_mirror-ion_100.gkyl interp sel --z0 1.05 pl --title 'Distribution Function at z=1.05' --xlabel '$v_\parallel$' --ylabel '$\mu$'&
pgkyl gk_lorentzian_mirror-ion_100.gkyl interp sel --z0 1.1 pl --title 'Distribution Function at z=1.1' --xlabel '$v_\parallel$' --ylabel '$\mu$'&
