...
# frame=0
pgkyl gk_wham-ion_BiMaxwellianMoments_$frame.gkyl interp pl --title "BiMaxwellian Moments at Frame ${frame}" --xlabel 'Z, m' --subplot-ylabels 'Density $m^3$, $U_\parallel m/s$, $T_\parallel/m$, $T_\perp/m$' --saveas python-plots/ion_BiMaxwellian_moments_frame${frame}.png --no-show &
