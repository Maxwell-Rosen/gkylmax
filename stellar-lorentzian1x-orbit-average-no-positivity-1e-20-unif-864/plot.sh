...
pgkyl ../stellar-lorentzian1x-orbit-average/gk_lorentzian_mirror-ion_BiMaxwellianMoments_45.gkyl gk_lorentzian_mirror-ion_BiMaxwellianMoments_45.gkyl interp ev 'f 2,3 1.67e-27 2.014 * 1.6e-19 / scale_comp' pl -f0 --legend "unif pos 288,unif npos 864" --title 'Bi-Maxwellian Moments — comparison (frame 45)' --xlabel 'Axial Position z (m)' --subplot-ylabels 'Density $m^{-3}$, $U_\parallel$ (m/s), $T_\parallel$ (eV), $T_\perp$ (eV)' --saveas "python-plots/ion_BiMaxwellianMoments_compare_uniform_pos.png" --no-show &

pgkyl ../stellar-lorentzian1x-orbit-average-no-positivity-1e-20-nunif/gk_lorentzian_mirror-ion_BiMaxwellianMoments_45.gkyl gk_lorentzian_mirror-ion_BiMaxwellianMoments_45.gkyl interp ev 'f 2,3 1.67e-27 2.014 * 1.6e-19 / scale_comp' pl -f0 --legend "nunif 216,unif 864" --title 'Bi-Maxwellian Moments — comparison (frame 45)' --xlabel 'Axial Position z (m)' --subplot-ylabels 'Density $m^{-3}$, $U_\parallel$ (m/s), $T_\parallel$ (eV), $T_\perp$ (eV)' --saveas "python-plots/ion_BiMaxwellianMoments_compare_nunif_216.png" --no-show &

pgkyl ../stellar-lorentzian1x-orbit-average-nonuniformz-positivity/gk_lorentzian_mirror-ion_BiMaxwellianMoments_45.gkyl gk_lorentzian_mirror-ion_BiMaxwellianMoments_45.gkyl interp ev 'f 2,3 1.67e-27 2.014 * 1.6e-19 / scale_comp' pl -f0 --legend "nunif 216,unif 864" --title 'Bi-Maxwellian Moments — comparison (frame 45)' --xlabel 'Axial Position z (m)' --subplot-ylabels 'Density $m^{-3}$, $U_\parallel$ (m/s), $T_\parallel$ (eV), $T_\perp$ (eV)' --saveas "python-plots/ion_BiMaxwellianMoments_compare_nunif_216_w_positivity.png" --no-show &
