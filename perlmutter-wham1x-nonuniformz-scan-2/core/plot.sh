...
pgkyl gk_wham-b_i.gkyl interp pl --title "b_i" --saveas "$saveLoc-geo-b_i.png" --no-show &
pgkyl gk_wham-bmag.gkyl interp pl --title "bmag" --saveas "$saveLoc-geo-bmag.png" --no-show &
pgkyl gk_wham-cmag.gkyl interp pl --title "cmag" --saveas "$saveLoc-geo-cmag.png" --no-show &
pgkyl gk_wham-jacobgeo.gkyl interp pl --title "jacobgeo" --saveas "$saveLoc-geo-jacobgeo.png" --no-show &
pgkyl gk_wham-jacobtot.gkyl interp pl --title "jacobtot" --saveas "$saveLoc-geo-jacobtot.png" --no-show &
pgkyl gk_wham-mapc2p.gkyl interp pl --title "mapc2p" --saveas "$saveLoc-geo-mapc2p.png" --no-show &
pgkyl gk_wham-mc2nu_pos.gkyl interp pl --title "mc2nu_pos" --saveas "$saveLoc-geo-mc2nu_pos.png" --no-show &
