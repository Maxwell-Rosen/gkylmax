...
frame_max_plus1 = 101#301
time_per_frame = 1e-6

# Nz_arr = ['32', '64', '96', '128', '192', '288']
# nonuniform_frac = ['0.000', '0.333', '0.666', '0.999']
frame_arr = [100]#[100, 300]
Nz_arr = ['288', '192', '128']
nonuniform_frac = ['0.000', '0.200', '0.400']
...
def load_positivity_integrated(filebase):
  filename = str(filebase+'misc/gk_wham-ion_positivity_shift_integrated_moms.gkyl')
  pgData_M0 = pg.GData(filename)
  M = pgData_M0.get_values()
  M0 = np.array(M[:,0])
  M1 = np.array(M[:,1])
  M2par = np.array(M[:,2])
  M2perp = np.array(M[:,3])
  time = np.squeeze(np.array(pgData_M0.get_grid()))
  return time, M0, M1, M2par, M2perp
...
def plot_intM0():
  ...
  for iZ in range(len(Nz_arr)):
    for iS in range(len(nonuniform_frac)):
      ...
      t, intM0 = loadM0_integrated(filebase)
...
def plot_positivity_M0():
  print("Plotting positivity of M0")
  plt.figure( figsize = figsize_dim)
  linenumber = 0
  for iZ in range(len(Nz_arr)):
    for iS in range(len(nonuniform_frac)):
      ...
      time, M0, M1, M2par, M2perp = load_positivity_integrated(filebase)
      plt.subplot(len(Nz_arr), len(nonuniform_frac), linenumber+1)
      plt.plot(time, M0, \
               color = linecolors[linenumber], \
               linestyle = linestyles[linenumber])
      linenumber += 1
      plt.title("N_z = "+Nz+", nonuniform frac = "+nonuniform_frac_str)
      plt.xlabel('Time, seconds')
      plt.ylabel('Positivity of M0')
  plt.tight_layout()
  plt.savefig(outDir+'positivity_M0'+figureFileFormat)

def plot_positivity_M0_combined():
  print("Plotting positivity of M0 combined")
  plt.figure( figsize = figsize_dim)
  linenumber = 0
  for iZ in range(len(Nz_arr)):
    for iS in range(len(nonuniform_frac)):
  ...
  plt.xlabel('Time, seconds')
  plt.ylabel('Positivity of M0')
  plt.title('Positivity of M0')
  plt.legend()
  plt.tight_layout()
  plt.savefig(outDir+'positivity_M0_combined'+figureFileFormat)

def plot_positivity_M1():
  print("Plotting positivity of M1")
  plt.figure( figsize = figsize_dim)
  linenumber = 0
  for iZ in range(len(Nz_arr)):
    for iS in range(len(nonuniform_frac)):
      ...
      plt.title("N_z = "+Nz+", nonuniform frac = "+nonuniform_frac_str)
      plt.xlabel('Time, seconds')
      plt.ylabel('Positivity of M1')
  plt.tight_layout()
  plt.savefig(outDir+'positivity_M1'+figureFileFormat)

def plot_positivity_M2par():
  print("Plotting positivity of M2par")
  plt.figure( figsize = figsize_dim)
  linenumber = 0
  for iZ in range(len(Nz_arr)):
    for iS in range(len(nonuniform_frac)):
      ...
      plt.title("N_z = "+Nz+", nonuniform frac = "+nonuniform_frac_str)
      plt.xlabel('Time, seconds')
      plt.ylabel('Positivity of M2par')
  plt.tight_layout()
  plt.savefig(outDir+'positivity_M2par'+figureFileFormat)

def plot_positivity_M2perp():
  print("Plotting positivity of M2perp")
  plt.figure( figsize = figsize_dim)
  linenumber = 0
  for iZ in range(len(Nz_arr)):
    for iS in range(len(nonuniform_frac)):
      ...
      time, M0, M1, M2par, M2perp = load_positivity_integrated(filebase)
      plt.subplot(len(Nz_arr), len(nonuniform_frac), linenumber+1)
      plt.plot(time, M2perp, \
               color = linecolors[linenumber], \
               linestyle = linestyles[linenumber])
      linenumber += 1
      plt.title("N_z = "+Nz+", nonuniform frac = "+nonuniform_frac_str)
      plt.xlabel('Time, seconds')
      plt.ylabel('Positivity of M2perp')
  plt.tight_layout()
  plt.savefig(outDir+'positivity_M2perp'+figureFileFormat)

def plot_positivity_M1_combined():
  print("Plotting positivity of M1 combined")
  plt.figure( figsize = figsize_dim)
  linenumber = 0
  for iZ in range(len(Nz_arr)):
    for iS in range(len(nonuniform_frac)):
  ...
  plt.xlabel('Time, seconds')
  plt.ylabel('Positivity of M1')
  plt.title('Positivity of M1')
  plt.legend()
  plt.tight_layout()
  plt.savefig(outDir+'positivity_M1_combined'+figureFileFormat)

def plot_positivity_M2par_combined():
  print("Plotting positivity of M2par combined")
  plt.figure( figsize = figsize_dim)
  linenumber = 0
  for iZ in range(len(Nz_arr)):
    for iS in range(len(nonuniform_frac)):
  ...
  plt.xlabel('Time, seconds')
  plt.ylabel('Positivity of M2par')
  plt.title('Positivity of M2par')
  plt.legend()
  plt.tight_layout()
  plt.savefig(outDir+'positivity_M2par_combined'+figureFileFormat)

def plot_positivity_M2perp_combined():
  print("Plotting positivity of M2perp combined")
  plt.figure( figsize = figsize_dim)
  linenumber = 0
  for iZ in range(len(Nz_arr)):
    for iS in range(len(nonuniform_frac)):
  ...
  plt.xlabel('Time, seconds')
  plt.ylabel('Positivity of M2perp')
  plt.title('Positivity of M2perp')
  plt.legend()
  plt.tight_layout()
  plt.savefig(outDir+'positivity_M2perp_combined'+figureFileFormat)
...
def main():
  ...
  plot_functions = [
    ...
    plot_positivity_M0,
    plot_positivity_M1,
    plot_positivity_M2par,
    plot_positivity_M2perp,
    plot_positivity_M0_combined,
    plot_positivity_M1_combined,
    plot_positivity_M2par_combined,
    plot_positivity_M2perp_combined,
  ]
