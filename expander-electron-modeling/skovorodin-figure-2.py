...
filename_phi = str('./gk_wham-field_339.gkyl')
...
filename_BiMaxwellianMoms = str('./gk_wham-ion_BiMaxwellianMoments_339.gkyl')
...
plt.plot(R, boltzmann, 'k--', label = "$\ln(B_0/B)$")
plt.plot(K, phi, 'k-', label = "Gkeyll")
plt.plot(K, phi_hammett, 'y--', label = "$\ln(U B_0/ B U_0)$", linewidth=.7)
plt.xlabel('R')
plt.ylabel('$-e \phi / T_e$')
plt.xlim([0, 450])
plt.ylim([0, 6.5])
plt.legend()
plt.savefig('skovorodin-figure-2.png', dpi=300)
plt.close()
