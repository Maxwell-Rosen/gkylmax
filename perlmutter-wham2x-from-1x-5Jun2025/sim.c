...
void
radial_scale(double t, const double *xn, double *fout, void *ctx)
{
  struct gk_mirror_ctx *app = ctx;
  fout[0] = 1.0 * pow((xn[0] - app->psi_min) / (app->psi_max - app->psi_min), 1./2.0);
}
...
create_ctx(void)
{
  ...
  double t_end = 1e-4;
  int num_frames = 1e5; // Number of output frames.
  double write_phase_freq = 0.01; // Frequency of writing phase-space diagnostics (as a fraction of num_frames).
...
int main(int argc, char **argv)
{
  ...
  struct gkyl_gyrokinetic_species elc = {
    ...
    .init_from_file = {
      ...
      // .conf_scale = radial_scale,
      // .conf_scale_ctx = &ctx,
      .file_name = "/global/homes/m/mhrosen/scratch/gkylmax/initial-conditions/kinet-elc-288z-nu2000/gk_wham-elc_0.gkyl",
      .jacobgeo_inv_file_name = "/global/homes/m/mhrosen/scratch/gkylmax/initial-conditions/kinet-elc-288z-nu2000/gk_wham-jacobgeo_inv.gkyl",
    },
    .collisions = {
  ...
  struct gkyl_gyrokinetic_species ion = {
    ...
    .init_from_file = {
      ...
      // .conf_scale = radial_scale,
      // .conf_scale_ctx = &ctx,
      .file_name = "/global/homes/m/mhrosen/scratch/gkylmax/initial-conditions/kinet-elc-288z-nu2000/gk_wham-ion_0.gkyl",
      .jacobgeo_inv_file_name = "/global/homes/m/mhrosen/scratch/gkylmax/initial-conditions/kinet-elc-288z-nu2000/gk_wham-jacobgeo_inv.gkyl",
    },
    .collisions = {
      .collision_id = GKYL_LBO_COLLISIONS,
