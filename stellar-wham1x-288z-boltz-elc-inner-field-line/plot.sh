...
# pgkyl gk_wham-ion_BiMaxwellianMoments_1473.gkyl gk_wham-ion_BiMaxwellianMoments_1000.gkyl interp pl -f0 --title "BiMaxwellianMoments 1473" --saveas "$saveLoc-ion-BiMaxwellianMoments-1473.png"&
pgkyl gk_wham-ion_BiMaxwellianMoments_1473.gkyl gk_wham-ion_BiMaxwellianMoments_1000.gkyl interp ev "f[0] f[1] - f[1] /" pl --title "Percent difference in BiMaxwellianMoments" 


# pgkyl "gk_wham-ion_BiMaxwellianMoments_[0-9]*.gkyl" interp anim --float --fps 10&
# pgkyl "gk_wham-ion_BiMaxwellianMoments_[0-9]*.gkyl" interp col sel --z1 0.0 pl --title "midplane bimaxwellian moments" &
# pgkyl gk_wham-ion_integrated_moms.gkyl pl --title "ion integrated moms" &
