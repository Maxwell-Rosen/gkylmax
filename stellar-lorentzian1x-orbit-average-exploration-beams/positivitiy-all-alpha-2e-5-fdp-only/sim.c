...
create_ctx(void)
{
  ...
  enum gkyl_gyrokinetic_positivity_type positivity_type_oap = GKYL_GK_POSITIVITY_SHIFT;
  enum gkyl_gyrokinetic_positivity_type positivity_type_fdp = GKYL_GK_POSITIVITY_SHIFT;
