...
pgkyl --c2p gk_lorentzian_mirror-mc2nu_pos_deflated.gkyl gk_lorentzian_mirror-ion_BiMaxwellianMoments_0.gkyl gk_lorentzian_mirror-ion_BiMaxwellianMoments_65.gkyl interp ev 'f 1,2 1.67e-27 2.014 * 1.6e-19 / scale_comp' pl --xlabel 'Axial Position z (m)' --ylabel 'Density $m^{-3}$' --title 'Comparison: loss cone versus Yushmanov potential' --legend 'Loss cone,Yushmanov' -f0 --saveas yushmanov-comparison.png --no-show &
