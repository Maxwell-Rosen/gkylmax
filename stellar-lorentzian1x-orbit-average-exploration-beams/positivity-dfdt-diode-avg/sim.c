...
create_ctx(void)
{
  ...
  enum gkyl_gyrokinetic_positivity_type positivity_type_oap = GKYL_GK_POSITIVITY_FDOT_RESTRICT_DIODE_AVG;
  enum gkyl_gyrokinetic_positivity_type positivity_type_fdp = GKYL_GK_POSITIVITY_FDOT_RESTRICT_DIODE_AVG;
