...
pgkyl "gk_wham-elc_M0_0.gkyl" interp pl --title "Initial electron density" --saveas "$saveLoc-kinetic-elc-M0-0.png" --ylabel "Density" --xlabel "z" --no-show &
pgkyl "gk_wham-field_0.gkyl" interp pl --title "Initial field" --saveas "$saveLoc-field-0.png" --ylabel "Potential, V" --xlabel "z" --no-show &
pgkyl "gk_wham-ion_M0_0.gkyl" interp pl --title "Initial ion density" --saveas "$saveLoc-kinetic-ion-M0-0.png" --ylabel "Density" --xlabel "z" --no-show &
pgkyl "gk_wham-elc_M0_0.gkyl" -t "ion" "gk_wham-ion_M0_0.gkyl" -t "elc" interp pl --logy -f0 --title "Initial density" --saveas "$saveLoc-kinetic-M0-0.png" --ylabel "Density" --xlabel "z" --no-show &
