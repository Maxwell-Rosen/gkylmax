...
frame=$(ls gk_wham-ion_cflrate_*.gkyl | sed -E 's/.*_([0-9]+)\.gkyl/\1/' | sort -n | tail -1)
...
pgkyl --c2p-vel gk_wham-ion_mapc2p_vel.gkyl gk_wham-ion_source_0.gkyl gk_wham-ion_0.gkyl interp sel --z2 0.5 pl -c --xlabel 'Axial Position z (m)' --ylabel 'Parallel Velocity $v_\parallel$ (m/s)' --title 'Ion Source vs Distribution at $z_2=0.5$ (Frame 0) - WHAM1X' --logz --zmin 1e-25 --saveas python-plots/ion_source_vs_distf_z0.5_frame0.png --no-show &
pgkyl --c2p-vel gk_wham-ion_mapc2p_vel.gkyl gk_wham-ion_source_0.gkyl interp sel --z2 0.5 pl -c --xlabel 'Axial Position z (m)' --ylabel 'Parallel Velocity $v_\parallel$ (m/s)' --title 'Ion Source at $z_2=0.5$ (Frame 0) - WHAM1X' --logz --zmin 1e-25 --saveas python-plots/ion_source_z0.5_frame0.png --no-show &
pgkyl --c2p-vel gk_wham-ion_mapc2p_vel.gkyl gk_wham-ion_0.gkyl interp sel --z2 0.5 pl -c --xlabel 'Axial Position z (m)' --ylabel 'Parallel Velocity $v_\parallel$ (m/s)' --title 'Ion Distribution at $z_2=0.5$ (Frame 0) - WHAM1X' --logz --zmin 1e-25 --saveas python-plots/ion_distf_z0.5_frame0.png --no-show &
...
pgkyl gk_wham-ion_cflrate_${frame}.gkyl sel --z0 0.0 pl --title 'CFL Rate at z=0.0' --xlabel '$v_\parallel$ computational' --ylabel '$\mu$ computational' --logz --saveas python-plots/cfl_rate_z0.0_frame${frame}.png --no-show & 
# Plot cfl rate 5 frames ago
pgkyl gk_wham-ion_cflrate_$(($frame - 5)).gkyl sel --z0 0.0 pl --title 'CFL Rate at z=0.0 (5 frames ago)' --xlabel '$v_\parallel$ computational' --ylabel '$\mu$ computational' --logz --saveas python-plots/cfl_rate_z0.0_frame$(($frame - 5)).png --no-show &
...
pgkyl gk_wham-field_[0-9]*.gkyl interp sel --z0 0.98 col write -s -f field_time_trace_z0_eq_0,98 &
...
pgkyl gk_wham-ion_570.gkyl gk_wham-ion_575.gkyl interp ev 'f[1] f[0] - f[0] / abs' sel --z0 0.0 pl --title 'Fractional error between begining and end of 570 and 575' --saveas python-plots/ion_distf_diff_570_575.png --no-show &
...
# pgkyl good-run-enhanced-nu-IC/gk_wham-ion_cflrate_275.gkyl integ 1 pl --title 'cfl OAP integ 1 old' --logz &
# pgkyl good-run-enhanced-nu-IC/gk_wham-ion_cflrate_275.gkyl integ 2 pl --title 'cfl OAP integ 2 old' --logz &
# pgkyl good-run-enhanced-nu-IC/gk_wham-ion_cflrate_285.gkyl integ 1 pl --title 'cfl RDP integ 1' --logz &
# pgkyl good-run-enhanced-nu-IC/gk_wham-ion_cflrate_285.gkyl integ 2 pl --title 'cfl RDP integ 2' --logz &


# pgkyl gk_wham-ion_cflrate_7.gkyl integ 1 pl --title 'cfl OAP integ 1 relaxed' --logz &
# pgkyl gk_wham-ion_cflrate_7.gkyl integ 2 pl --title 'cfl OAP integ 2 relaxed' --logz &

# pgkyl good-run-enhanced-nu-IC/gk_wham-ion_cflrate_285.gkyl sel --z0 0.95 pl --title 'cfl OAP integ 1 old' --logz &
# pgkyl gk_wham-ion_cflrate_1.gkyl sel --z0 0.95 pl --title 'cfl OAP integ 2 relaxed' --logz &

# pgkyl good-run-enhanced-nu-IC/gk_wham-ion_cflrate_275.gkyl gk_wham-ion_cflrate_1.gkyl sel --z0 0.0 ev 'f[0] f[1] -' pl --title 'difference' --logz &
# pgkyl good-run-enhanced-nu-IC/gk_wham-ion_cflrate_275.gkyl gk_wham-ion_cflrate_1.gkyl sel --z0 0.0 pl &
