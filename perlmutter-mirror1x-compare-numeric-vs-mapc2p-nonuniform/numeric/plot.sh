...
# Animations of distribution function at z=0 and 0.98
pgkyl "$name-"$species"_[0-9]*.gkyl"\
  interp -b gkhyb -p1 sel --z0 0.0 animate --fps 4\
  --saveas "$saveLoc-z=0.mp4" &
pgkyl "$name-"$species"_[0-9]*.gkyl"\
  interp -b gkhyb -p1 sel --z0 0.98 animate --fps 4\
  --saveas "$saveLoc-z=0.98.mp4" &

pgkyl "$name"-ion_BiMaxwellianMoments_0.gkyl interp pl --title "ion_BiMaxwellianMoments_0" --saveas "$saveLoc-ion_BiMaxwellianMoments_0.png" --no-show &
