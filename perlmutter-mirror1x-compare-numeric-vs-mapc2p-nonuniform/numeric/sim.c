...
z_xi(double xi, double psi, void *ctx)
{
  ...
  int n_ct = 7;
  int n;
  double frac = 0.5; // 1 is full mapping, 0 is no mapping
  double z, left, right;
...
create_ctx(void)
{
  ...
  double Z_min = -2.48;
  double Z_max = 2.48;
  // double z_min = -2.50388;
  // double z_max = 2.50388;
  ...
  double Z_m = 0.98;
  double z_m = 0.984084 * (z_max/2.50388);
  printf("z_m: %g\n", z_m);
...
int main(int argc, char **argv)
{
  ...
  struct gkyl_efit_inp efit_inp = {
    .filepath = "../../eqdsk/wham_lorentzian.geqdsk",
  ...
  struct gkyl_mirror_geo_grid_inp grid_inp = {
    ...
    .zmin = -2.48,  // Z of lower boundary
    .zmax =  2.48,  // Z of upper boundary 
  };
  ...
  struct gkyl_gk gk = {  // GK app
    ...
    .geometry = {
      ...
      .nonuniform_mapping_fraction = 0.5,
    },
    .num_periodic_dir = 0,
    .periodic_dirs = {},
    .num_species = 1,
