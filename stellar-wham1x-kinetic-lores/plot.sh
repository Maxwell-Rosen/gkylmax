...
# pgkyl --c2p-vel "gk_wham_modified-"$species"_mapc2p_vel.gkyl" "gk_wham_modified-"$species"_0.gkyl" -t f0 "gk_wham_modified-"$species"_106.gkyl" -t f1 \
# interp sel --z0 0.0 ev -t diff "f0 f1 -" activ -t f0,f1,diff pl &

pgkyl --c2p-vel "gk_wham_modified-"$species"_mapc2p_vel.gkyl" "gk_wham_modified-"$species"_0.gkyl" -t f0 "gk_wham_modified-"$species"_106.gkyl" -t f1 \
interp integrate 2 ev -t diff "f0 f1 -" activ -t f0,f1,diff pl &
...
# pgkyl gk_wham-ion_BiMaxwellianMoments_0.gkyl interp -b ms -p1 sel --comp 0 pl --title "ion density" --xlabel "z" --ylabel "density" &
# pgkyl gk_wham-elc_BiMaxwellianMoments_0.gkyl interp -b ms -p1 sel --comp 0 pl --title "elc density" --xlabel "z" --ylabel "density" &

# pgkyl gk_wham-elc_0.gkyl interp -b gkhyb -p1 sel --z0 0.0 pl --title "elc distribution function" --xlabel "vpar" --ylabel "mu" &
